  ...
  return (
    <div className='descriptionbox'>
      ...
      <div className="descriptionbox-description">
        <p>An e-commerce websdite is an online platform that facilitates the 
          ...
          the global reach they offer. </p>
        <p>E-commerce websites typically display products or
          services along with detailed descriptions, images prices, and any available
          variations (e.g., sizes, colors). Each product usually has its
          own dedicated page with relevatn information</p>
      </div>
    </div>
  )
}
